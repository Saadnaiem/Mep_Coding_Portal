...
export const STATUS_MAP: Record<RequestStatus, { label: React.ReactNode; color: string; icon: React.ReactNode }> = {
  ...
  partially_approved: { label: 'Completed', color: 'bg-gradient-to-r from-emerald-50 to-red-50 text-[#0F3D3E] border border-gray-200', icon: <ShieldCheck size={14} /> },
  
  approved_pending_erp: { label: 'Approved', color: 'bg-[#E0F2F1] text-[#0F3D3E] border border-[#0F3D3E]/20', icon: <ShieldCheck size={14} /> },
  approved_pending_ecommerce: { label: 'Waiting E-Commerce Approval', color: 'bg-purple-50 text-purple-700 border border-purple-200', icon: <Package size={14} /> },
