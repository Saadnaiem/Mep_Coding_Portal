...
ALTER TABLE public.vendors ADD COLUMN IF NOT EXISTS cr_document_url_document_url text;
...
ALTER TABLE public.vendors ADD COLUMN IF NOT EXISTS guarantee_Letter text;
ALTER TABLE public.vendors ADD COLUMN IF NOT EXISTS non_Refundable_Listing_fees text;