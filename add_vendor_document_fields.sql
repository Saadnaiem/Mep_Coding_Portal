...
ALTER TABLE public.vendors ADD COLUMN IF NOT EXISTS guarantee_letter_url text;
ALTER TABLE public.vendors ADD COLUMN IF NOT EXISTS listing_fees_document_url text;